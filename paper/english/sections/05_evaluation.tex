...
\Description{Bar chart showing detection performance metrics: Precision at 0.969, Recall at 0.995, and F1-Score at 0.978, all exceeding the 0.85 target threshold marked by a dashed line. Error bars show 95\% confidence intervals.}
...
\Description{Box plot comparing execution times: DeepBridge automatic detection shows mean time of 0.55 seconds with low variance, while manual identification shows mean time of 1.60 seconds with higher variance, demonstrating a 2.91× speedup.}
